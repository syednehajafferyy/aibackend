    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col">
      ...
      <header className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base font-bold text-white tracking-tight">DevForge AI Service</h1>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                  Gemini 2.0 Flash
                </span>
              </div>
              <p className="text-xs text-slate-400 hidden sm:block">Backend API & Live Component Service</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <a
              href="https://github.com/syednehajafferyy/aibackend.git"
              target="_blank"
              rel="noreferrer"
